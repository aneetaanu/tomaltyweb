...
//	Subscribe to World has from
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Availability', 'redux-framework-demo' ),
        'id'         => 'availability',
        'subsection' => true,
        'desc'       => __( ' ', 'redux-framework-demo' ) . '',
        'fields'     => array(
               ...
               'id'       => 'availability_bar',
               'type'     => 'text',
               'title'    => __( 'Availability Header top bar', 'redux-framework-demo' ),
               'subtitle' => __( '', 'redux-framework-demo' ),
               'desc'     => __( '', 'redux-framework-demo' ),
                ),
        )
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Header Contact Field', 'redux-framework-demo' ),
        'id'         => 'header_contact',
        'subsection' => true,
        'desc'       => __( ' ', 'redux-framework-demo' ) . '',
        'fields'     => array(
...
//////////////////////
    ...
    Redux::setSection( $opt_name, array(
 'title'      => __( 'Enable and Disable', 'redux-framework-demo' ),
        'id'         => 'hideshow',
        'desc'       => __( ' ', 'redux-framework-demo' ) . '',
        'subsection' => true,
        'fields'     => array(
          array(
           'id'       => 'enable_disable',
           'type'     => 'checkbox',
           'title'    => __( 'Hide and Show Social Icon', 'redux-framework-demo' ),
           'subtitle' => __( '', 'redux-framework-demo' ),
           'desc'     => __( '', 'redux-framework-demo' ),
           ),
        )
 ...
 'title'      => __( 'Twitter', 'redux-framework-demo' ),
  ...
  Redux::setSection( $opt_name, array(
 'title'      => __( 'Appointment', 'redux-framework-demo' ),
        'id'         => 'a_url',
        'desc'       => __( ' ', 'redux-framework-demo' ) . '',
        'subsection' => true,
        'fields'     => array(
